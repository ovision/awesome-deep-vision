# awesome deep vision
A curated list of awesome deep vision resources

A curated list of awesome computer vision resources, inspired by [awesome-php](https://github.com/ziadoz/awesome-php).

## Contributing
Please feel free to send me [pull requests](https://github.com/jbhuang0604/awesome-computer-vision/pulls) or email (langxl@hfut.edu.cn) to add links.
